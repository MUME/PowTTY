...
typedef struct {
    ...
    int win_name_always;
    int width, height;
	/* window position! by billj - requested by Manwë */
	int xPos,yPos;
	...
	/* powwow options */
	char powwowpager[1024];
	char powwoweditor[1024];
	char powwowcfg[1024];
	char powwowdir[1024];
	char powwowtmp[1024];
	int powwowexit;
...
HWND getmyhwnd();
#define UWM_PROCESS_STOPPED (WM_USER+17)
